...
/**
 * Bean definitions for {@link RegistryRepository}.
 */
@Generated
public class RegistryRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'registryRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getRegistryRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'registryRepository'.
   */
  public static BeanDefinition getRegistryRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, RegistryRepository.class, Registry.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.neumaticos.sandro.backend_tire_management.repository.RegistryRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.RegistryRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.neumaticos.sandro.backend_tire_management.repository.RegistryRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getRegistryRepositoryInstanceSupplier();
